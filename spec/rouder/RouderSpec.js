...
describe('Rouder', function() {

  ['Modern', 'Legacy'].forEach(function(browser) {
    describe('for ' + browser.toLowerCase() + ' browsers', function() {
      var rouder;
      var window;
      var config;
      var callback;
      ...
      it('should be listening when started', function() {
        rouder.start();
